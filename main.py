...
label_szczegoly_obiektu_post = Label(ramka_szczegoly_obiektow, text='Posts:')
label_szczegoly_obiektu_post.grid(row=1, column=6)

label_szczegoly_obiektu_post_wartosc = Label(ramka_szczegoly_obiektow, text='....')
